...
sealed class KotlinType : Annotated, KotlinTypeMarker {
     ...
     *
     * Refined type should obey following contract:
     * - its memberScope is refined  (see [SimpleTypeImpl.scopeFactory]
     * - its typeConstructor is refined (see [TypeConstructor.refine]
     * - its arguments are refined
     * - all other similar methods (e.g., upper/lower bounds for flexible types, projections for captured types, etc.
     *   should return refined types as well)
     *
     * NB. Correct subtyping or equality for refined types from different Refiners *is not guaranteed*
     *
     * Implementation notice:
     * Basically, this is a simple form of double-dispatching, used to incapsulate
     * structure of specific implementaitons, which means that compound types most probably would like

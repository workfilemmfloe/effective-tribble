...
class IntrinsicsMap<IntrinsicMethod> {
    ...
    private static final FqNameUnsafe RECEIVER_PARAMETER_FQ_NAME = new FqNameUnsafe("T");
    ...
    private static FqNameUnsafe getReceiverParameterFqName(@NotNull CallableMemberDescriptor descriptor) {
        ...
        if (classifier instanceof TypeParameterDescriptor) {
            return RECEIVER_PARAMETER_FQ_NAME;
        }

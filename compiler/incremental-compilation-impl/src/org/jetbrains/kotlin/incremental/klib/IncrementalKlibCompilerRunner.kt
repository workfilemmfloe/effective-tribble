...
abstract class IncrementalKlibCompilerRunner<Args : CommonCompilerArguments, CacheManager : IncrementalCachesManager<*>>(
    ...
    protected val dirtySourcesSinceLastTimeFile = File(workingDir,
                                                       DIRTY_SOURCES_FILE_NAME
    )
    protected val lastBuildInfoFile = File(workingDir,
                                           LAST_BUILD_INFO_FILE_NAME
    )
    ...
    fun compile(
        ...
        fun rebuild(reason: () -> String): ExitCode {
            ...
            return compileIncrementally(args, caches, allKotlinFiles,
                                        CompilationMode.Rebuild(), messageCollector)
        }
    ...
    protected open fun makeServices(
        ...
        Services.Builder().apply {
            ...
            register(CompilationCanceledStatus::class.java,
                     EmptyCompilationCanceledStatus
            )
        }

...
abstract class SpringKtLightHighlightingTestCase: AbstractCodeInsightActionTest(){
    ...
    fun configureFileSet(vararg filenames: String){
        TestFixtureExtension.getFixture<SpringTestFixtureExtension>()!!.configureFileSet(myFixture, filenames.asList())
    }

...
abstract class BasicBoxTest(
    ...
    private fun generateJavaScriptFile(
        ...
        val config = createConfig(module, dependencies, friends, multiModule, incrementalData = null)
        ...
        if (module.hasFilesToRecompile) {
            ...
            val recompiledConfig = createConfig(module, dependencies, friends, multiModule, incrementalData)
    ...
    private fun createConfig(
            module: TestModule, dependencies: List<String>, friends: List<String>, multiModule: Boolean, incrementalData: IncrementalData?
    ): JsConfig {
